...
const CompletedOrders = () => {
  ...
  <Navbar>
          ...
          <Heading display={"flex"} justifyContent={"center"} textDecoration={"underline"}>Completed Orders</Heading>
          ...
          <AccordionItem bg={"rgb(251, 197, 60)"}>
            ...
            cod.map((val, index) => (
              ...
              <AccordionPanel pb={4} key={index} bg={"white"}>
                <AccordionItem>
                  <h2>
                    <AccordionButton bg={"rgb(251, 197, 60)"} variant={"none"}>
                      <Box
                        as="span"
                        flex="1"
                        textAlign="left"
                  ...
                  <AccordionPanel pb={4}>
                    ...
                    val.items.map((val, index) => (
                        ...
                        <Box bg={"white"} fontFamily={"'Roboto Slab', serif"} mt={3} key={index} display={"flex"} gap={10}>
                          <Box>
                            <Image
                              src={val.image}
                              alt="image"
